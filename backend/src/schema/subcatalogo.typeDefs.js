export default /* GraphQL */ `
  ...
  type SubCatalogoEdge {
    node: SubCatalogo!
    cursor: ID!
  }
  type SubCatalogoConnection {
    edges: [SubCatalogoEdge!]!
    pageInfo: PageInfo!
  }

  input SubCatalogoInput {
    catalogoId: Int!
    codigo: String!
    nombre: String!
    version: Int!
  }
  input SubCatalogoUpdateInput {
    id: Int!
    codigo: String!
    nombre: String!
    version: Int!
  ...
  extend type Query {
    ...
    validarCodigoSubCatalogo(catalogoId: Int!, codigo: String!): Boolean!
