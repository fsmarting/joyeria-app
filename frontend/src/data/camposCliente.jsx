...
export const camposCliente = [
  ...
  { nombre: 'telefono', etiqueta: 'Teléfono', tipoForm: 'text', maxLength: 30, ancho: '120px', ordenListado: 2 },
  {
    nombre: 'tierId', etiqueta: 'Tier', tipoForm: 'select', ancho: '100px', ordenListado: 3,
    ...
    render: (f) => {
      ...
      if (!n) return '-';
      const c = n === 'VIP' ? 'warning' : n === 'Recurrente' ? 'primary' : 'secondary';
      return <span className={`badge bg-${c}`}>{n}</span>;
    },
  },
  {
    nombre: 'canalId', etiqueta: 'Canal', tipoForm: 'select', ancho: '110px', ordenListado: 4,
